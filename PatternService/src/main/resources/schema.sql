...
CREATE TABLE IF NOT EXISTS PATTERN_SECTION_THREE_PATTERN_TABLES
(
    pattern_section_three_id BIGINT,
    pattern_table_id         BIGINT,
    CONSTRAINT pk_pattern_section_three_of_pattern_tables PRIMARY KEY (pattern_section_three_id, pattern_table_id)
);
...
(
    ...
    organization_branch   VARCHAR                                 NOT NULL,
    organization_division VARCHAR                                 NOT NULL,
    division_license      VARCHAR                                 NOT NULL,
    date                  DATE                                    NOT NULL,
