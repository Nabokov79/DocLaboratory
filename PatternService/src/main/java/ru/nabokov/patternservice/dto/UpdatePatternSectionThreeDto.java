...
@Getter
@AllArgsConstructor
@Schema(description = "Данные для изменения информации в разделе № 3 шаблона отчета")
public class UpdatePatternSectionThreeDto {

    @Schema(description = "Индентификатор")
    @NotNull(message = "pattern section three id should not be blank")
    @Positive(message = "pattern section three id can only be positive")
    private Long id;
