...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "Данные нового раздела № 3 шаблона отчета")
public class NewPatternSectionThreeDto {
    ...
    @NotNull(message = "header template of the three section should not be blank")
    ...
    private List<NewSubheadingThreeDto> subheadings;
}
